...
def mitigator(enable_alerts, enable_deauth):
...
def set_configs():
    ...
    parser.add_argument('--enable-alerts',
                    dest='enable_alerts',
                    action='store_true',
                    help='Send alerts via email when attack is detected')

    parser.add_argument('--enable-deauth',
                    dest='enable_deauth',
                    action='store_true',
                    help='Send deauth packets to confirmed rogue APs')
